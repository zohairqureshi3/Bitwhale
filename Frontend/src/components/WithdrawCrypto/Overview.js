...
import PayCoin from '../../assets/images/pay-icon.svg';
...
import { Dropdown, Overlay, Tooltip, OverlayTrigger, Button, Modal } from 'react-bootstrap';
...
const Overview = () => {
    ...
    const handleWithdraw = () => {
        if (withdrawCoins == 0) {
            Swal.fire({
                // title: 'Success',
                text: "Withdraw Amount cannot be 0. Please enter a number",
                icon: 'info',
                                            ...
                                            <div className="wrap-coin-box d-flex flex-lg-row flex-column align-items-lg-start align-items-center mb-50">
                                                ...
                                                <div className="select-crypto w-100">
                                                    <div className="d-flex justify-content-between align-items-center flex-md-row flex-column mb-50">
                                                        ...
                                                        <Link to="/manage-address"> <span className="dot text-capitalize">Address Management</span> </Link>
                                                    </div>
                                                    ...
                                                    <div className="d-flex flex-md-row flex-column justify-content-md-between align-items-center ju">
                                                        <div className="mb-md-0 mb-3 text-md-start text-center w-100">
                                                            <span className='w-100 d-flex justify-content-between'>
                                                                {/* <span className="text-uppercase d-inline-block mb-3">{withdrawCoins} {selectedCurrency && selectedCurrency.symbol ? selectedCurrency.symbol : ""}</span>
                                                                <span className="text-uppercase d-inline-block mb-3"> <FontAwesomeIcon icon={faArrowRight} /> </span> */}
                                ...
                                <div className="pay-box d-flex justify-content-between align-items-center mb-3">
                                    <div className="d-flex align-items-center">
                                        <figure className="mb-0 me-3">
                                            <img src={PayCoin} alt="" className="img-fluid" />
                                        </figure>
