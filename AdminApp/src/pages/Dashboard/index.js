                ...
                <div className="col-lg-9 col-md-8">
                    <div className="content-wrapper">
                        ...
                        <div className="content-box">
                            ...
                            {/* <div>
                        <button className='btn-default hvr-bounce-in nav-button' onClick={handleShowBalance}>
                            Add Admin Balance
                        </button>
                        <br />
                        <span>Working on it</span>
                            ...
                            {username === 'Admin' ?
                                <div>
                                    <button className='btn-default hvr-bounce-in nav-button me-2 mb-2' onClick={handleShow}>
                                        Send Amount to User
                                    </button>
                                    <SentAmountToUsers />
                                </div>
