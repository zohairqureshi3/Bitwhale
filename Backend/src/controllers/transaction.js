...
exports.store = async (req, res) => {
    try {
        ...
        if (user) {
            const newTransaction = new Transaction({ userId: user._id, fromAccount: req.body.fromAccount, toAccount: user._id, currencyId: req.body.currencyId, amount: req.body.amount });
